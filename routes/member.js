...
router.route('/:id')
    ...
    .put( isAuth, validateMember, wrapAsync(controllerMember.update))
...
router.post('/:periode_id/:divisi_id/store', isAuth, validateMember,  wrapAsync(controllerMember.store) )
